...
%GUI_INFO M-file for gui_info.fig
...
%
%      GUI_INFO('Property','Value',...) creates a new GUI_INFO using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to gui_info_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      GUI_INFO('CALLBACK') and GUI_INFO('CALLBACK',hObject,...) call the
%      local function named CALLBACK in GUI_INFO.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 10-Apr-2015 02:49:00
...
% Choose default command line output for gui_info
