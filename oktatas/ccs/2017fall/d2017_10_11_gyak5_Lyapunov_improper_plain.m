%% Lyapunov function demonstration - improper LF
...
% specific Lyapunov function. This Lyapunov function is improper, since not all 
% level-sets of the Lyapunov function are compact subsets of the state space.
%% Parameters
%%
x0 = [5.5;-0.4];
eigvals = [-0.01 -0.0];
