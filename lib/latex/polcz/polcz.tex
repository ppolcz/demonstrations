...
\newpage
\section{Uj Tetelblokk}
\begin{thm}*{Alma}(Kutyagumi)
    Ez itt az uj tetelblokk
\end{thm}

\begin{thm}*{Alma}(Kutyagumi)|matlabFunction|
    Ez itt az uj tetelblokk
\end{thm}

\begin{thm}*{Alma}(Kutyagumi)|\tt matlabFunction|
    Ez itt az uj tetelblokk
\end{thm}

\begin{thm}*(Kutyagumi)|\tt matlabFunction|
    Ez itt az uj tetelblokk
\end{thm}

\begin{thm}*{Alma}|\tt matlabFunction|
    Ez itt az uj tetelblokk
\end{thm}
...
\begin{thm}{Alma}|\tt matlabFunction|\hun<magenta>
    Ez itt az uj tetelblokk
\end{thm}

\begin{thm}{Alma}|\tt matlabFunction|\hun|red|
    Ez itt az uj tetelblokk
\end{thm}
